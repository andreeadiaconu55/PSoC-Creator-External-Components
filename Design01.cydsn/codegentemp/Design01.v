...
// numarator_3(CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=numarator_3, CY_CONFIG_TITLE=numarator_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=numarator_1, CY_INSTANCE_SHORT_NAME=numarator_1, CY_MAJOR_VERSION=0, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=numarator_1, )
module numarator_3_0 (
    Clock,
    Direction,
    Out0,
    Out1,
    ...
    if (1)
    begin : LUT_1
        reg [2:0] tmp__LUT_1_reg;
        wire [3:0] tmp__LUT_1_ins;
        assign tmp__LUT_1_ins = {Direction,Out2,Out1,Out0};
        always @(posedge Clock)
        begin
            case (tmp__LUT_1_ins)
                4'b0000 :  tmp__LUT_1_reg = 3'b001;
                4'b0001 :  tmp__LUT_1_reg = 3'b010;
                4'b0010 :  tmp__LUT_1_reg = 3'b011;
                4'b0011 :  tmp__LUT_1_reg = 3'b100;
                4'b0100 :  tmp__LUT_1_reg = 3'b101;
                4'b0101 :  tmp__LUT_1_reg = 3'b110;
                4'b0110 :  tmp__LUT_1_reg = 3'b111;
                4'b0111 :  tmp__LUT_1_reg = 3'b000;
                4'b1000 :  tmp__LUT_1_reg = 3'b111;
                4'b1001 :  tmp__LUT_1_reg = 3'b000;
                4'b1010 :  tmp__LUT_1_reg = 3'b001;
                4'b1011 :  tmp__LUT_1_reg = 3'b010;
                4'b1100 :  tmp__LUT_1_reg = 3'b011;
                4'b1101 :  tmp__LUT_1_reg = 3'b100;
                4'b1110 :  tmp__LUT_1_reg = 3'b101;
                4'b1111 :  tmp__LUT_1_reg = 3'b110;
            endcase
        end
        assign {Out2,Out1,Out0} = tmp__LUT_1_reg;
    end
    // -- LUT LUT_1 end --
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("8266de28-adea-4844-a488-7c976d2230d0"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("5aefb23a-b793-4040-929e-f553006a10b6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("e8bdbcd1-84c8-40b5-98cc-38560ae762a2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
