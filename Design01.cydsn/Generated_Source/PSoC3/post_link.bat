...
CD /D "C:\Keil\UV4"
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
IF NOT EXIST "C:\Users\Andreea\OneDrive\Desktop\ASDN\Laborator_6\Design01.cydsn\Design01.svd" rem "C:\Users\Andreea\OneDrive\Desktop\ASDN\Laborator_6\Design01.cydsn\Design01.sfr"
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
